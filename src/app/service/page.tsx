    ...
    <>
      ...
      <section className="flex flex-col items-center justify-center py-[60px] px-[20px] lg:py-[30px] lg:px-[30px] w-full">
        <motion.div initial="hidden"
          whileInView="visible"
          variants={variants}
          viewport={{ once: true }} className="flex flex-col lg:flex-row lg:items-start lg:justify-start items-center justify-center lg:max-w-[1280px] max-w-[390px] w-full gap-[40px] lg:gap-[84px]">
