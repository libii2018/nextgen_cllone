    ...
    <>
      ...
      <section className="flex flex-col items-center justify-center bg-white py-[110px] px-[30px] lg:pt-[90px] lg:px-[30px] lg:pb-[60px] w-full">
        <motion.div initial="hidden"
          ...
          <div className="flex flex-col lg:grid lg:grid-cols-2 lg:grid-rows-2 flex-1 items-center justify-center w-full gap-9 lg:gap-6">
            <div className="flex flex-col items-start justify-start p-8 bg-[#f6f7f9] max-sm:w-full gap-6">
                ...
                <div className="flex flex-col items-center justify-center gap-7 w-full overflow-hidden">
                  <div className="flex flex-col items-center lg:justify-start lg:items-start justify-center gap-4 w-full">
                    <div className="flex flex-row items-start justify-start gap-4 w-full">
                      <div className="flex flex-col items-center justify-center rounded-[100%] w-[68px] h-[68px]">
                        <img
                          src="https://framerusercontent.com/images/fdHLmgeqLeliulsqQ5AfzTz2g.png"
                          alt=""
                          className="w-full h-full object-center object-cover"
                        />
                      </div>
                    ...
                    <div className="flex flex-col items-start justify-start w-[92%]">
                      <p className="text-lg text-[#3b3b3b] font-normal leading-[1.7em]">
                        “NextGen made the entire process enjoyable. Their team’s
                        professionalism, attentiveness, and dedication to our
                        project were clear from start to finish, and their
                        attention to detail truly went above and beyond.”
                      </p>
                    </div>
                  </div>
                  <div className="flex flex-row items-center justify-between w-full">
                ...
                <div className="flex flex-col items-center justify-center gap-7 w-full overflow-hidden">
                  <div className="flex flex-col items-center lg:justify-start lg:items-start justify-center gap-4 w-full">
                    <div className="flex flex-row items-start justify-start gap-4 w-full">
                      <div className="flex flex-col items-center justify-center rounded-[100%] w-[68px] h-[68px]">
                        <img
                          src="https://framerusercontent.com/images/k82yy3ClW9R6lB8ekv5EbYBJg0.png"
                          alt=""
                          className="w-full h-full object-center object-cover"
                        />
                      </div>
                    ...
                    <div className="flex flex-col items-start justify-start w-[92%]">
                      <p className="text-lg text-[#3b3b3b] font-normal leading-[1.7em]">
                        “NextGen exceeded our expectations at every stage. Their
                        team was attentive, professional, and committed to
                        delivering our vision with precision. The level of
                        detail in their work was truly impressive.”
                      </p>
                    </div>
                  </div>
                  <div className="flex flex-row items-center justify-between w-full">
                ...
                <div className="flex flex-col items-center justify-center gap-7 w-full overflow-hidden">
                  <div className="flex flex-col items-center lg:justify-start lg:items-start justify-center gap-4 w-full">
                    <div className="flex flex-row items-start justify-start gap-4 w-full">
                      <div className="flex flex-col items-center justify-center rounded-[100%] w-[68px] h-[68px]">
                        <img
                          src="https://framerusercontent.com/images/oqnXJym7o3W1KsspmU6FajeuCC4.png"
                          alt=""
                          className="w-full h-full object-center object-cover"
                        />
                      </div>
                    ...
                    <div className="flex flex-col items-start justify-start w-[92%]">
                      <p className="text-lg text-[#3b3b3b] font-normal leading-[1.7em]">
                        “From consultation to completion, NextGen was an
                        absolute pleasure to work with. Their team’s
                        professionalism, attention to detail, and commitment to
                        our project were exceptional, bringing our vision to
                        life flawlessly.”
                      </p>
                    </div>
                  </div>
                ...
                <div className="flex flex-col items-center justify-center gap-7 w-full overflow-hidden">
                  <div className="flex flex-col items-center lg:justify-start lg:items-start justify-center gap-4 w-full">
                    <div className="flex flex-row items-start justify-start gap-4 w-full">
                      <div className="flex flex-col items-center justify-center rounded-[100%] w-[68px] h-[68px]">
                        <img
                          src="https://framerusercontent.com/images/TCc3CVS0WblaOpHOLbOQ1qme4s.png"
                          alt=""
                          className="w-full h-full object-center object-cover"
                        />
                      </div>
                    ...
                    <div className="flex flex-col items-start justify-start w-[92%]">
                      <p className="text-lg text-[#3b3b3b] font-normal leading-[1.7em]">
                        “NextGen delivered an outstanding experience. From the
                        first consultation to the final product, their
                        professionalism, attention to detail, and commitment to
                        our vision were beyond what we could have hoped for.”
                      </p>
                    </div>
                  </div>
                  <div className="flex flex-row items-center justify-between w-full">
      ...
      <section className="flex flex-col items-center justify-center bg-white py-[60px] px-[20px] w-full">
        <motion.div initial="hidden"
              whileInView="visible"
              variants={variants}
              viewport={{ once: true }} className="flex flex-col items-center justify-center lg:max-w-[1280px] md:max-w-[390px] w-full gap-[40px]">
